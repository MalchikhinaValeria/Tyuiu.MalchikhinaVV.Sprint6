...
namespace Tyuiu.MalchikhinaVV.Sprint6.Task7.V28.Test
{
    [TestClass]
    public sealed class DataServiceTest
    {
        ...
        {
            string path = @"C:\Users\Home\source\repos\Tyuiu.MalchikhinaVV.Sprint6\InPutDataFileTask7V28.csv";
            DataService ds = new DataService();

            int[,] wait = { { 12, 7, 0, -9, 4, 5, 7, -10, -12, -5},
